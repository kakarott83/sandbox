...
namespace WfvXmlConfigurator.BO.ContentLogics
{
    public class ContentManager
    {
        ...
        public ContentManager ()
        {
            ...
            propAttributeAdderEntry.AddAttributes("syscode", new CategoryAttribute("Schlüssel"), new DescriptionAttribute("Eindeutiger Bezeichner für das Objekt"));
            ...
            propAttributeAdderEntry.AddAttributes("references", new CategoryAttribute("Verweise"), new DescriptionAttribute("Im Dashboard oder Wizard enthaltene Teilelemente"));
            propAttributeAdderEntry.AddAttributes("coderfu", new DescriptionAttribute("Funktionsberechtigungscode"));
            propAttributeAdderEntry.AddAttributes("codermo", new DisplayNameAttribute("Modulberechtigungscode"), new DescriptionAttribute("Modulberechtigungscode"));
            ...
            propAttributeAdderCustomentry.AddAttributes("detailsyscode", new CategoryAttribute("Verweise"), new ItemsSourceAttribute(typeof(DetailDashboardSyscodesItemsSource)), new DescriptionAttribute("Eindeutiger Bezeichner der Detailansicht"));
            propAttributeAdderCustomentry.AddAttributes("createsyscode", new CategoryAttribute("Verweise"), new ItemsSourceAttribute(typeof(DetailDashboardSyscodesItemsSource)), new DescriptionAttribute("Eindeutiger Bezeichner der Maske zum Erstellen eines neuen Objekts"));
            propAttributeAdderCustomentry.AddAttributes("forwardsyscode", new CategoryAttribute("Verweise"), new ItemsSourceAttribute(typeof(AllSyscodesItemsSource)), new DescriptionAttribute("Eindeutiger Bezeichner der Maske, zu der man nach dem Speichern weitergeleitet wird"));
            ...
            propAttributeAdderReferences.AddAttributes("syscode", new CategoryAttribute("Verweise"), new ItemsSourceAttribute(typeof(DetailListSyscodesItemsSource)), new DescriptionAttribute("Eindeutiger Bezeichner der eingebetteten Maske"));
