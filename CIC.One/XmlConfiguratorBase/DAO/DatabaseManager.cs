...
namespace XmlConfiguratorBase.DAO
{
    ...
    internal class DatabaseManager : IDataManager
    {
        ...
        {
            log.Debug("Database Manager Mapping" + Assembly.GetAssembly(typeof(Mapper)));
            Mapper.CreateMap<WfvEntry, WFV>();
            Mapper.CreateMap<WfvConfigEntry, WFV>();
            log.Debug("Database Manager Mapping Completed" + Assembly.GetAssembly(typeof(Mapper)));
        }
