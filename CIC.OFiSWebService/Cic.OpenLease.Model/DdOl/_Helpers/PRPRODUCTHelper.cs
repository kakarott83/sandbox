...
namespace Cic.OpenLease.Model.DdOl
{
    ...
    public static class PRPRODUCTHelper
    {
        ...
        public static System.Collections.Generic.List<PRPRODUCT> DeliverPRPRODUCTs(OlExtendedEntities context, long sysPerson)
        {
        ...
        */
        ...
        public static int? DeliverConditionType(OlExtendedEntities context, long sysPrProduct)
        {
            List<PRPRODUCT> products = rebuild(context);
        ...
        public static KALKTYP DeliverKalkTyp(OlExtendedEntities context, long sysPrProduct)
        {
        ...
        public static long DeliverSysInttype(OlExtendedEntities context, long sysPrProduct)
        {
        ...
        private static List<PRPRODUCT> rebuild(Cic.OpenLease.Model.DdOl.OlExtendedEntities context)
        {
