...
namespace Cic.OpenLease.Model.DdEurotax
{
    ...
    public partial class ETGGROUPEXCL
    {
        ...
        public static Cic.Basic.Data.Objects.Property.InfoPackageDictionary DeliverInfoPackageDictionary()
        {
            ...
            {
                _InfoPackageDictionary = new Cic.Basic.Data.Objects.Property.InfoPackageDictionary(typeof(ETGGROUPEXCL));
            }
        ...
        public partial struct FieldNames
        {
            ...
            public static string TXTCODE2CD2
            {
                get { return "TXTCODE2CD2"; }
            }
