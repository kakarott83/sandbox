...
namespace Cic.OpenLease.Model.DdEurotax
{
    ...
    public partial class ETGEUROCOL
    {
        ...
        public static Cic.Basic.Data.Objects.Property.InfoPackageDictionary DeliverInfoPackageDictionary()
        {
            ...
            {
                _InfoPackageDictionary = new Cic.Basic.Data.Objects.Property.InfoPackageDictionary(typeof(ETGEUROCOL));
            }
        ...
        public partial struct FieldNames
        {
            ...
            public static string COLCODECD2
            {
                get { return "COLCODECD2"; }
            }
