...
namespace Cic.OpenLease.Model.DdEurotax
{
    ...
    public partial class ETGMEDIAETX
    {
        ...
        public static Cic.Basic.Data.Objects.Property.InfoPackageDictionary DeliverInfoPackageDictionary()
        {
            ...
            {
                _InfoPackageDictionary = new Cic.Basic.Data.Objects.Property.InfoPackageDictionary(typeof(ETGMEDIAETX));
            }
        ...
        public partial struct FieldNames
        {
            ...
            public static string IMGOBJECTCD
            {
                get { return "IMGOBJECTCD"; }
            }
