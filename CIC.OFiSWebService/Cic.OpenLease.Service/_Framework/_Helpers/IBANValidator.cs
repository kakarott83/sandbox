...
namespace Cic.OpenLease.Service
{
    ...
    public class IBANValidator
    {
        ...
        //country codes, fixed length for those countries, inner structure, IBAN example, IBAN requirement, SEPA, appliance of EU REGULATION 924/2009;260/2012 and EUR, BLZ-LENGHT, BLZ-POS
        ...
        String[][] ilbced = new String[][]
        {
            ...
            new String[]{"AD", "24", "F04F04A12",		"AD1200012030200359100100",		"n", "n", "n", "n","4","4","4","0"},
           new String[]{"AE", "23", "F03F16",		"AE070331234567890123456",		"n", "n", "n", "n","3","4","0","0"},
           new String[]{"AL", "28", "F08A16",		"AL47212110090000000235698741",		"n", "n", "n", "n","3","4","4","1"},
           new String[]{"AT", "20", "F05F11",		"AT611904300234573201",       "n", "y", "y", "y","5","4","0","0"},
           new String[]{"AZ", "28", "U04A20",		"AZ21NABZ00000000137010001944",		"n", "n", "n", "n","4","4","0","0"},
           new String[]{"BA", "20", "F03F03F08F02",	"BA391290079401028494",      "n", "n", "n", "n","3","4","3","0"},
           new String[]{"BE", "16", "F03F07F02",		"BE68539007547034",      "n", "y", "y", "y","3","4","0","0"},
           new String[]{"BG", "22", "U04F04F02A08",	"BG80BNBG96611020345678",		"n", "y", "y", "n","4","4","4","0"},
           new String[]{"BH", "22", "U04A14",		"BH67BMAG00001299123456",		"y", "n", "n", "n","4","4","0","0"},
           new String[]{"BR", "29", "F08F05F10U01A01",	"BR9700360305000010009795493P1",	"n", "n", "n", "n","8","4","5","0"},
           new String[]{"CH", "21", "F05A12",		"CH9300762011623852957",		"n", "y", "n", "n","5","4","0","0"},
           new String[]{"CR", "21", "F03F14",		"CR0515202001026284066",		"n", "n", "n", "n","3","4","0","0"},
           new String[]{"CY", "28", "F03F05A16",		"CY17002001280000001200527600",		"n", "y", "y", "y","3","4","5","0"},
           new String[]{"CZ", "24", "F04F06F10",		"CZ6508000000192000145399",		"n", "y", "y", "n","4","4","0","0"},
           new String[]{"DE", "22", "F08F10",		"DE89370400440532013000",		"n", "y", "y", "y","8","4","0","0"},
           new String[]{"DK", "18", "F04F09F01",		"DK5000400440116243",       "n", "y", "y", "n","4","4","0","0"},
           new String[]{"DO", "28", "U04F20",		"DO28BAGR00000001212453611324",		"n", "n", "n", "n","4","4","0","0"},
           new String[]{"EE", "20", "F02F02F11F01",	"EE382200221020145685",      "n", "y", "y", "y","2","4","0","0"},
           new String[]{"ES", "24", "F04F04F01F01F10",	"ES9121000418450200051332",		"n", "y", "y", "y","4","4","4","1"},
           new String[]{"FI", "18", "F06F07F01",		"FI2112345600000785",     "n", "y", "y", "y","6","4","0","0"},
           new String[]{"FO", "18", "F04F09F01",		"FO6264600001631634",      "n", "y", "n", "n","4","4","0","0"},
           new String[]{"FR", "27", "F05F05A11F02",	"FR1420041010050500013M02606",		"n", "y", "y", "y","5","4","5","0"},
           new String[]{"GF", "27", "F05F05A11F02",	"FR1420041010050500013M02606",		"n", "y", "y", "y","5","4","5","0"},
           new String[]{"PF", "27", "F05F05A11F02",	"FR1420041010050500013M02606",		"n", "y", "y", "y","5","4","5","0"},
           new String[]{"TF", "27", "F05F05A11F02",	"FR1420041010050500013M02606",		"n", "y", "y", "y","5","4","5","0"},

           new String[]{"GB", "22", "U04F06F08",		"GB29NWBK60161331926819",		"n", "y", "y", "n","4","4","6","0"},
           new String[]{"GE", "22", "U02F16",		"GE29NB0000000101904917",		"n", "n", "n", "n","2","4","0","0"},
           new String[]{"GI", "23", "U04A15",		"GI75NWBK000000007099453",		"n", "y", "y", "n","4","4","0","0"},
           new String[]{"GL", "18", "F04F09F01",		"GL8964710001000206",     "n", "y", "n", "n","4","4","0","0"},
           new String[]{"GR", "27", "F03F04A16",		"GR1601101250000000012300695",		"n", "y", "y", "y","3","4","4","0"},
           new String[]{"GT", "28", "A04A20",		"GT82TRAJ01020000001210029690",		"n", "n", "n", "n","4","4","0","0"},
           new String[]{"HR", "21", "F07F10",		"HR1210010051863000160",		"n", "n", "n", "n","7","4","0","0"},
           new String[]{"HU", "28", "F03F04F01F15F01",	"HU42117730161111101800000000",		"n", "y", "y", "n","3","4","4","1"},
           new String[]{"IE", "22", "U04F06F08",		"IE29AIBK93115212345678",		"n", "y", "y", "y","4","4","6","0"},
           new String[]{"IL", "23", "F03F03F13",		"IL620108000000099999999",		"n", "n", "n", "n","3","4","3","0"},
           new String[]{"IS", "26", "F04F02F06F10",	"IS140159260076545510730339",		"n", "y", "y", "n","4","4","2","0"},
           new String[]{"IT", "27", "U01F05F05A12",	"IT60X0542811101000000123456",		"n", "y", "y", "y","5","5","5","0"},
           new String[]{"KW", "30", "U04A22",		"KW81CBKU0000000000001234560101",	"y", "n", "n", "n","4","4","0","0"},
           new String[]{"KZ", "20", "F03A13",		"KZ86125KZT5004100100",      "n", "n", "n", "n","3","4","0","0"},
           new String[]{"LB", "28", "F04A20",		"LB62099900000001001901229114",		"n", "n", "n", "n","4","4","0","0"},
           new String[]{"LI", "21", "F05A12",		"LI21088100002324013AA",		"n", "y", "y", "n","5","4","0","0"},
           new String[]{"LT", "20", "F05F11",		"LT121000011101001000",      "n", "y", "y", "n","5","4","0","0"},
           new String[]{"LU", "20", "F03A13",		"LU280019400644750000",       "n", "y", "y", "y","3","4","0","0"},
           new String[]{"LV", "21", "U04A13",		"LV80BANK0000435195001",		"n", "y", "y", "n","4","4","0","0"},
           new String[]{"MC", "27", "F05F05A11F02",	"MC5811222000010123456789030",		"n", "y", "y", "n","5","4","5","0"},
           new String[]{"MD", "24", "U02F18",		"MD24AG000225100013104168",		"n", "n", "n", "n","2","4","0","0"},
           new String[]{"ME", "22", "F03F13F02",		"ME25505000012345678951",		"n", "n", "n", "n","3","4","0","0"},
           new String[]{"MK", "19", "F03A10F02",		"MK07250120000058984",      "n", "n", "n", "n","3","4","0","0"},
           new String[]{"MR", "27", "F05F05F11F02",	"MR1300020001010000123456753",		"n", "n", "n", "n","5","4","5","0"},
           new String[]{"MT", "31", "U04F05A18",		"MT84MALT011000012345MTLCAST001S",	"n", "y", "y", "y","4","4","5","0"},
           new String[]{"MU", "30", "U04F02F02F12F03U03",	"MU17BOMM0101101030300200000MUR",	"n", "n", "n", "n","6","4","2","0"},
           new String[]{"NL", "18", "U04F10",		"NL91ABNA0417164300",       "n", "y", "y", "y","4","4","0","0"},
           new String[]{"NO", "15", "F04F06F01",		"NO9386011117947",      "n", "y", "y", "n","4","4","0","0"},
           new String[]{"PK", "24", "U04A16",		"PK36SCBL0000001123456702",		"n", "n", "n", "n","4","4","0","0"},
           new String[]{"PL", "28", "F08F16",		"PL61109010140000071219812874",		"y", "y", "y", "n","3","4","0","0"},
           new String[]{"PS", "29", "U04A21",		"PS92PALS000000000400123456702",	"n", "n", "n", "n","4","4","0","0"},
           new String[]{"PT", "25", "F04F04F11F02",	"PT50000201231234567890154",		"n", "y", "y", "y","4","4","4","0"},
           new String[]{"RO", "24", "U04A16",		"RO49AAAA1B31007593840000",		"n", "y", "y", "n","4","4","0","0"},
           new String[]{"RS", "22", "F03F13F02",		"RS35260005601001611379",		"n", "n", "n", "n","3","4","0","0"},
           new String[]{"SA", "24", "F02A18",		"SA0380000000608010167519",		"y", "n", "n", "n","2","4","0","0"},
           new String[]{"SE", "24", "F03F16F01",		"SE4550000000058398257466",		"n", "y", "y", "n","3","4","0","0"},
           new String[]{"SI", "19", "F05F08F02",		"SI56263300012039086",      "n", "y", "y", "n","2","4","3","0"},
           new String[]{"SK", "24", "F04F06F10",		"SK3112000000198742637541",		"n", "y", "y", "y","4","4","6","0"},
           new String[]{"SM", "27", "U01F05F05A12",	"SM86U0322509800000000270100",		"n", "n", "n", "n","5","5","5","0"},
           new String[]{"TN", "24", "F02F03F13F02",	"TN5910006035183598478831",		"n", "n", "n", "n","2","4","3","0"},
           new String[]{"TR", "26", "F05A01A16",		"TR330006100519786457841326",		"y", "n", "n", "n","5","4","0","0"},
           new String[]{"VG", "24", "U04F16",		"VG96VPVG0000012345678901",		"n", "n", "n", "n","4","4","0","0"},
