...
{
    /// <summary>
    /// Calculates Kasko Provision for BMW
    /// </summary>
    [System.CLSCompliant(true)]
    public class KaskoProvisionCalculator : AbstractProvisionCalculator
    {
        ...
        public ProvisionDto calculate(DdOlExtended context, PROVDao prov, ProvisionDto param)
        {
            ...
            _Log.Debug("Kasko Provision für " + param.versicherungspraemieexkl + "="+rval.provision);
