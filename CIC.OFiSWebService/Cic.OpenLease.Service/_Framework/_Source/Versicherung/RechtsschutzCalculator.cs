...
{
    /// <summary>
    /// Calculates the BMW AIDA RechtsschutzVS
    /// SYSQUOTE - Prämie
    /// </summary>
    [System.CLSCompliant(true)]
    public class RechtsschutzCalculator : AbstractVSCalculator
    {
        #region Constants
        ...
        public ServiceAccess.DdOl.InsuranceResultDto calculate(DdOlExtended context, long sysPerole, long sysBrand, VSTYP vstyp, InsuranceParameterDto param)
        {
            ...
            if (sysquote==0)
                throw new NullReferenceException("SYSQUOTE in Rechtsschutz nicht konfiguriert für VSTYP " + vstyp.SYSVSTYP);
