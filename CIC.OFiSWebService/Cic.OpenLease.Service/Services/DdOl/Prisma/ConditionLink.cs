...
namespace Cic.OpenLease.Service
{
    ...
    public class ConditionLink
    {
        ...
        /// <returns></returns>
        public static List<long> getParameter(object context, ConditionLinkType ctype, ThreadSafeDictionary<ConditionLinkType, String> map, IObTypDao obDao, DateTime perDate)
        {
