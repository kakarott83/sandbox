...
namespace Cic.OpenLease.Service.Services.DdOl.BO
{
    ...
    /// </summary>
    public class ReflectionInfoBo
    {
        object Data;
        private Dictionary<string, ReflectionInfoBo> loaded = new Dictionary<string, ReflectionInfoBo>();
        ...
        public ReflectionInfoBo(object Data)
        {
            this.Data = Data;
        }
        ...
        internal void setValue(string InfoPath, object o)
        {
            //List<string> infos = InfoPath.Split('.').ToList();
            List<string> infos = splitPath(InfoPath);
            setValue(infos, o);
        ...
        /// So kann zum Beispiel beim expandieren schon alle Listenelemente gespeichert werden und somit Reflection umgangen werden
        /// </summary>
        /// <param name="InfoPath">Stelle, wo es gespeichert werden soll (schon gesplittet durch ".")</param>
        /// <param name="o">Objekt zum speichern</param>
        private void setValue(List<string> InfoPath, object o)
        {
            ...
            if (InfoPath.Count == 0)
            {
                if (!loaded.ContainsKey(currentCheck))
                    loaded.Add(currentCheck, new ReflectionInfoBo(o));
                return;
            }
            else
            {
        ...
        private object getValue(List<string> infoPath, out bool success)
        {
            ...
            ReflectionInfoBo rbo = new ReflectionInfoBo(nextObject);
