...
namespace Cic.OpenOne.CarConfigurator.BO.OracleConfigurationManager
{
	...
	internal static class DeleteConfigurationHelper
	{
		#region Methods
		// TODO BK 0 BK, Not tested
		internal static bool Execute(string userCode, System.Guid configurationIdentifier)
		{
            ...
            using (System.Transactions.TransactionScope TransactionScope = new System.Transactions.TransactionScope())
            {
                ...
                if (ConfigurationPackage.CMUSERS.SYSCMUSERS == User.SYSCMUSERS)
                {
                    try
                    {
                        ...
                        Result =ConfigurationPackagesHelper.Delete(new System.Guid(ConfigurationPackage.CMCIDENTS.IDENTIFIER), ConfigurationManager);
                    }
                    catch
                    {
                        // Close
