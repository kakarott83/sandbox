...
namespace Cic.OpenOne.CarConfigurator.BO.OracleConfigurationManager
{
	...
	internal static class PublishConfigurationHelper
	{
		#region Methods
		// TODO BK 0 BK, Not tested
		internal static bool Execute(string userCode, System.Guid configurationIdentifier, bool isPublic)
		{
            ...
            using (System.Transactions.TransactionScope TransactionScope = new System.Transactions.TransactionScope())
            {
                ...
                if (ConfigurationPackage.CMUSERS.SYSCMUSERS == User.SYSCMUSERS)
                {
                    ...
                    {
                        // Update
                        Result =ConfigurationPackagesHelper.UpdateIsPublic(ConfigurationPackage.SYSCMCPKGS, isPublic, ConfigurationManager);
                    }
                    catch
                    {
                        // Close
