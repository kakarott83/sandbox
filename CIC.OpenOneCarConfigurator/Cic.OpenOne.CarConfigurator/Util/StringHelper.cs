...
{
    /// <summary>
    /// Provides additional methods for string type.
    /// </summary>
    /// <remarks>NOTE BK, Conflict with namespace name CicTest.Basic.StringHelper is not relevant, because it is a test namespace</remarks>
    ...
    public static class StringHelper
    {
        ...
        private static String StringTextUndefined = "Undefined";
        /// <summary>
        /// MarkClose
        /// </summary>
        ...
        /// <remarks>
        /// TESTEDBY GetMarkTestFixture.NullString
        /// TESTEDBY GetMarkTestFixture.EmptyString
        /// TESTEDBY GetMarkTestFixture.SpaceString
        /// TESTEDBY GetMarkTestFixture.SpacesAndSingleCharString
        /// </remarks>
        public static string GetMark(string value)
        {
            ...
            {
                // Return
                // NOTE BK, There are more returns
                return (MarkOpen + MarkClose);
            }
            else
            {
                // Return
                // NOTE BK, There are more returns
                return (MarkOpen + " " + value + " " + MarkClose);
            }
        }

        /// <summary>
        /// Delivers the undefined mark.
        /// </summary>
        /// <returns>The undefined mark.</returns>
        /// <remarks>TESTEDBY DeliverUndefinedMarkTestFixture.Test</remarks>
        public static string DeliverUndefinedMark()
        {
            // Return
            return Cic.OpenOne.Util.StringHelper.GetMark(StringTextUndefined);
        }
        ...
        {
            // Check value
            if (Cic.OpenOne.Util.StringHelper.IsTrimedNullOrEmpty(value))
            {
                // Set default value
                value = defaultValue;
            }
        ...
        /// <summary>
        /// Gets the undefined mark if null or empty.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The undefined mark if <paramref name="value"/>value is null or empty; otherwise the <paramref name="value"/> value.</returns>
        /// <remarks>
        /// TESTEDBY GetUndefinedMarkIfNullOrEmptyTestFixture.NullString
        /// TESTEDBY GetUndefinedMarkIfNullOrEmptyTestFixture.EmptyString
        /// TESTEDBY GetUndefinedMarkIfNullOrEmptyTestFixture.SpaceString
        /// TESTEDBY GetUndefinedMarkIfNullOrEmptyTestFixture.SingleCharString
        /// TESTEDBY GetUndefinedMarkIfNullOrEmptyTestFixture.SpaceAndSingleCharString
        /// </remarks>

        public static string GetUndefinedMarkIfNullOrEmpty(string value)
        {
            // Return
            return Cic.OpenOne.Util.StringHelper.TrimAndGetDefaultIfNullOrEmpty(value, Cic.OpenOne.Util.StringHelper.DeliverUndefinedMark());
        }
        ...
        private static string MyEncodeSpecialChars(string value, char escapeChar, char[] specialChars, System.Text.Encoding encoding)
        {
            ...
            if (value != null)
            {
                if (!string.IsNullOrEmpty(value))
                {
                    ...
                    {
                        throw new System.ArgumentNullException("specialChars");
                    }
