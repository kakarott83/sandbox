namespace Cic.OpenOne.CarConfigurator.Util.Expressions
{
    ...
    // For example: 101 XOR 30
    public sealed class XorExpression<T> : Expression<T>
    {
        #region Private constants
        private const string CnstToStringPrefix = "XOR";
        #endregion
        ...
        #region Constructors
        public XorExpression(Expression<T> leftExpression, Expression<T> rightExpression)
            : base()
        {
