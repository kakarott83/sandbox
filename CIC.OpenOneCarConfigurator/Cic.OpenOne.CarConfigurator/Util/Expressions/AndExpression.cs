...
namespace Cic.OpenOne.CarConfigurator.Util.Expressions
{
	...
	// Represents the AND expression
	// For example: {101} AND {30}
	public sealed class AndExpression<T> : Expression<T>
	{
		#region Private constants
		private const string CnstToStringPrefix = "AND";
		#endregion
		...
		#region Constructors
		public AndExpression(Expression<T> leftExpression, Expression<T> rightExpression)
			: base()
		{
