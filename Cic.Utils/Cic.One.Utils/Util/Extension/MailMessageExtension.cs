...
{
    /// <summary>
    /// Mail Message Helper class
    /// Used to allow controlled Storing of Mailmessage Objects in Memory or Files
    /// </summary>
    public static class MailMessageExtension
    {
        /// <summary>
        /// Store Mailmessage in MIME format into a Byte Array
        /// </summary>
        /// <param name="Message">MailMessage Object</param>
        /// <returns>MIME Mail Stored on byte Array</returns>
        public static byte[] getMessage(this MailMessage Message)
        {
            ...
            using (MemoryStream _memoryStream = new MemoryStream())
            {
                ...
                object _mailWriter = _mailWriterContructor.Invoke(new object[] { _memoryStream });
        ...
        /// <summary>
        /// Save MailMessage in MIME Format on specified file
        /// </summary>
        /// <param name="Message">MailMessage Object</param>
        /// <param name="FileName">Path of File to store</param>
