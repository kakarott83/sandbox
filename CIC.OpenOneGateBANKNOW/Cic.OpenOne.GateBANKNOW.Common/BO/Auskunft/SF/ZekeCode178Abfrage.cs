...
namespace Cic.OpenOne.GateBANKNOW.Common.BO.Auskunft.SF
{
    ...
    /// ZekeCode178Abfrage
    /// </summary>
    public class ZekeCode178Abfrage : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    { 
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().eCode178Abfrage(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().eCode178Abfrage(inDto);
        }
    }
}
