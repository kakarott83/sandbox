...
namespace Cic.OpenOne.GateBANKNOW.Common.BO.Auskunft.SF
{
    ...
    /// ZekeCode178Mutieren
    /// </summary>
    public class ZekGetARMs : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().getARMs(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().getARMs(inDto);
        }
    }
}
