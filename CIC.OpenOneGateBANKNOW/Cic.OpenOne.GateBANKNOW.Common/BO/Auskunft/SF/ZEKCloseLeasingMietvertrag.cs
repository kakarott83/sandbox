...
{
    /// <summary>
    /// ZEK Close LeasingMietvertrag Class
    /// </summary>
    public class ZEKCloseLeasingMietvertrag : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeLeasingMietvertrag(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeLeasingMietvertrag(inDto);
        }
    }
}
