...
{
    /// <summary>
    /// ZEK Update Teilzahlungskredit Class
    /// </summary>
    public class ZekUpdateTeilzahlungskredit : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateTeilzahlungskredit(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateTeilzahlungskredit(inDto);
        }
    }
}
