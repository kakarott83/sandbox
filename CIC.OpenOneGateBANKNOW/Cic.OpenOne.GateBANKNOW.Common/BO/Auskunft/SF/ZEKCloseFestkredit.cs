...
{
    /// <summary>
    /// ZEK Close Festkredit Class
    /// </summary>
    public class ZEKCloseFestkredit : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeFestkredit(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeFestkredit(inDto);
        }
    }
}
