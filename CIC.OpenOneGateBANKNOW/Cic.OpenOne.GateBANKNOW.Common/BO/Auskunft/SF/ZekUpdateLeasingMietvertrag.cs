...
{
    /// <summary>
    /// ZEK Update LeasingMietvertrag Class
    /// </summary>
    public class ZekUpdateLeasingMietvertrag : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateLeasingMietvertrag(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateLeasingMietvertrag(inDto);
        }
    }
}
