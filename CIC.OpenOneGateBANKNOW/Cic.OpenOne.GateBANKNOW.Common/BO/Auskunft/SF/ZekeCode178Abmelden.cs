...
namespace Cic.OpenOne.GateBANKNOW.Common.BO.Auskunft.SF
{
    ...
    /// ZekeCode178Abmelden
    /// </summary>
    public class ZekeCode178Abmelden : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
          /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().eCode178Abmelden(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().eCode178Abmelden(inDto);
        }
    }
