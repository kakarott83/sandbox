...
namespace Cic.OpenOne.GateBANKNOW.Common.BO.Auskunft.SF
{
    ...
    /// </summary>
    public class ZEKBatchUpdateContracts : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBatchBo().updateContractsBatch(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBatchBo().updateContractsBatch(inDto);
        }
    }
}