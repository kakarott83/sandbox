...
using Cic.OpenOne.GateBANKNOW.Common.Model.DdIc;

namespace Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft
{
    public class BankNowModelProfile4UI : Profile
    {
        /// <summary>
        /// Konfigurieren / ONLY FOR TESTUI
        /// </summary>
        protected override void Configure()
        {
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntKalkDto, ANGKALK>()
                    .ForMember(dest => dest.RSVGESAMT, opt => opt.MapFrom(src => src.calcRsvgesamt))
                    .ForMember(dest => dest.ZINSKOSTEN, opt => opt.MapFrom(src => src.calcZinskosten))
                    .ForMember(dest => dest.RSVMONAT, opt => opt.MapFrom(src => src.calcRsvmonat))
                    .ForMember(dest => dest.RSVZINS, opt => opt.MapFrom(src => src.calcRsvzins))
                    .ForMember(dest => dest.USTZINS, opt => opt.MapFrom(src => src.calcUstzins));
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AntragDto, ANTRAG>().ForAllMembers(opt => opt.Condition(srs => !srs.IsSourceValueNull));
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntKalkDto, ANTKALK>()
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntProvDto, ANTPROV>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntSubvDto, ANTSUBV>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntObBriefDto, ANTOBBRIEF>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntVsDto, ANTVS>();
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngAntKalkDto, ANGKALK>()
                   ...
                   .ForMember(dest => dest.RSVZINS, opt => opt.MapFrom(src => (decimal?)src.calcRsvzins))
                   .ForMember(dest => dest.USTZINS, opt => opt.MapFrom(src => (decimal?)src.calcUstzins));
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.AngebotDto, ANGEBOT>().ForAllMembers(opt => opt.Condition(srs => !srs.IsSourceValueNull));
            ...
            CreateMap<ZEKKIC, Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.ZekKarteninformationDescriptionDto>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.ZekKontokorrentkreditDescriptionDto, ZEKKKC>()
                .ForMember(dest => dest.KREDITLIMITE, opt => opt.MapFrom(src => (decimal?)src.kreditLimite))
                .ForMember(dest => dest.BEANSPRUCHTERKREDITPROZENT, opt => opt.MapFrom(src => (decimal?)src.beanspruchterKreditProzent));
            ...
            CreateMap<ZEKKGC, Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.ZekKreditgesuchDescriptionDto>();
            ...
            // Deltavista
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DVAddressDescriptionDto, Cic.OpenOne.GateBANKNOW.Common.DAO.Auskunft.DeltavistaRef2.AddressDescription>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DVOrderDescriptionDto, Cic.OpenOne.GateBANKNOW.Common.DAO.Auskunft.DeltavistaRef2.OrderDescriptor>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DVAddressDescriptionDto, Cic.OpenOne.GateBANKNOW.Common.DAO.Auskunft.DeltavistaRef2.AddressDescription>();
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DVOrderDescriptionDto, Cic.OpenOne.GateBANKNOW.Common.DAO.Auskunft.DeltavistaRef2.OrderDescriptor>();

            // DecisionEngine
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DecisionEngineInDto, DECONTRACT>()
                .ForMember(dest => dest.ERFASSUNGSKANAL, opt => opt.MapFrom(src => src.Erfassungskanal))
                .ForMember(dest => dest.GESCHAEFTSART, opt => opt.MapFrom(src => src.Geschaeftsart))
                ...
                .ForMember(dest => dest.NUTZUNGSART, opt => opt.MapFrom(src => src.Nutzungsart))
                ...
                .ForMember(dest => dest.FINANZIERUNGSBETRAG, opt => opt.MapFrom(src => src.Finanzierungsbetrag))
                .ForMember(dest => dest.KAUTION, opt => opt.MapFrom(src => src.Kaution))
                .ForMember(dest => dest.RATE, opt => opt.MapFrom(src => src.Rate))
                .ForMember(dest => dest.RESTWERT, opt => opt.MapFrom(src => src.Restwert))
                .ForMember(dest => dest.ZINSSATZ, opt => opt.MapFrom(src => src.Zinssatz));
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DecisionEngineInDto, DEOBJECT>()
                ...
                .ForMember(dest => dest.MARKE, opt => opt.MapFrom(src => src.Marke))
                .ForMember(dest => dest.MODELL, opt => opt.MapFrom(src => src.Modell))
                .ForMember(dest => dest.OBJEKTART, opt => opt.MapFrom(src => src.Objektart))
                ...
                .ForMember(dest => dest.STAMMNUMMER, opt => opt.MapFrom(src => src.Stammnummer))
                .ForMember(dest => dest.ZUBEHOERPREIS, opt => opt.MapFrom(src => src.Zubehoerpreis));
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.RecordRRDto, DEOPENLEASE>()
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.RecordRRDto, DEZEK>()
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.RecordRRDto, DEARBEIT>()
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.RecordRRDto, DEADRBONI>()
                .ForMember(dest => dest.KUNDENID, opt => opt.MapFrom(src => (long?)src.DV_KundenID))
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.RecordRRDto, DEAPPLICANT>()
            ...
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DecisionEngineInDto, DEPARTNER>()
                ...
                .ForMember(dest => dest.RECHTSFORM, opt => opt.MapFrom(src => src.Rechtsform))
                .ForMember(dest => dest.SPRACHE, opt => opt.MapFrom(src => src.Sprache))
                .ForMember(dest => dest.VERTRIEBSPARTNERART, opt => opt.MapFrom(src => src.Vertriebspartnerart))
                .ForMember(dest => dest.EVENTUALRESTWERTENGAGEMENT, opt => opt.MapFrom(src => src.Eventualrestwertengagement))
                .ForMember(dest => dest.EVENTUALVOLUMENENGAGEMENT, opt => opt.MapFrom(src => src.Eventualvolumenengagement))
                .ForMember(dest => dest.GARANTENLIMITE, opt => opt.MapFrom(src => src.Garantenlimite))
                .ForMember(dest => dest.PLZ, opt => opt.MapFrom(src => src.PLZ))
                .ForMember(dest => dest.RECHTSFORM, opt => opt.MapFrom(src => src.Rechtsform))
                .ForMember(dest => dest.RESTWERTENGAGEMENT, opt => opt.MapFrom(src => src.Restwertengagement))
                .ForMember(dest => dest.VOLUMENENGAGEMENT, opt => opt.MapFrom(src => src.Volumenengagement));
            CreateMap<Cic.OpenOne.GateBANKNOW.Common.DTO.Auskunft.DecisionEngineInDto, DESALES>()
