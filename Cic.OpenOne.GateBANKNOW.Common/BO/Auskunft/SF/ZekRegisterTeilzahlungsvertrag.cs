...
{
    public class ZekRegisterTeilzahlungsvertrag : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().registerTeilzahlungsvertrag(sysAuskunft);
        }
        /// <summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().registerTeilzahlungsvertrag(inDto);
        }
    }
}
