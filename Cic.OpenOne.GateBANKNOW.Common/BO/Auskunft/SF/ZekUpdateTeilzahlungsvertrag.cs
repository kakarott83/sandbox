...
{
    public class ZekUpdateTeilzahlungsvertrag : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateTeilzahlungsvertrag(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateTeilzahlungsvertrag(inDto);
        }
    }
}
