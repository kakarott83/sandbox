...
{
    /// <summary>
    /// ZEK Update Bardarlehen Class
    /// </summary>
    public class ZekUpdateBardarlehen : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateBardarlehen(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateBardarlehen(inDto);
        }
    }
}
