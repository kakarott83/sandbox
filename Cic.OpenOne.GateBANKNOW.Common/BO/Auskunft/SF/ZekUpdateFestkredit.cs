...
{
    /// <summary>
    /// ZEK Update Festkredit Class
    /// </summary>
    public class ZekUpdateFestkredit : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateFestkredit(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateFestkredit(inDto);
        }
    }
}
