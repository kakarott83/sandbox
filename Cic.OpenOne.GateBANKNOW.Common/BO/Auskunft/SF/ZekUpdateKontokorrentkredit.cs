...
{
    /// <summary>
    /// ZEK Update Kontokorrentkredit Class
    /// </summary>
    public class ZekUpdateKontokorrentkredit : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateKontokorrentkredit(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().updateKontokorrentkredit(inDto);
        }
    }
}
