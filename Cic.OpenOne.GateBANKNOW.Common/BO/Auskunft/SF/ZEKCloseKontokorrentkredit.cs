...
{
    /// <summary>
    /// ZEK Close Kontokorrentkredit Class
    /// </summary>
    public class ZEKCloseKontokorrentkredit : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeKontokorrentkredit(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeKontokorrentkredit(inDto);
        }
    }
}
