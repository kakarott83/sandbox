...
{
    /// <summary>
    /// ZEK Close Bardarlehen Class
    /// </summary>
    public class ZEKCloseBardarlehen : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().closeBardarlehen(sysAuskunft);
        }
