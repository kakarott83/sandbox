...
namespace Cic.OpenOne.GateBANKNOW.Common.BO.Auskunft.SF
{
    ...
    /// ZekeCode178Anmelden
    /// </summary>
    public class ZekeCode178Anmelden : AbstractAuskunftBo<ZekInDto, AuskunftDto>
    {
        /// <summary>
        /// do Auskunft
        /// </summary>
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().eCode178Anmelden(sysAuskunft);
        }
        ...
        {
            return AuskunftBoFactory.CreateDefaultZekBo().eCode178Anmelden(inDto);
        }
    }
}
