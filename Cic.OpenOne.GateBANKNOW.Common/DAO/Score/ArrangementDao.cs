...
namespace Cic.OpenOne.GateBANKNOW.Common.DAO.Score
{
	...
	public class ArrangementDao : IArrangementDao
	{
		...
		public void createOrUpdateArrangementDto (DTO.ScoreArrangementDto arrangementDto)
		{
			ScoreEntityDao entity = new ScoreEntityDao ();
			entity.createOrUpdateArrangement (arrangementDto);
		}
	}
}
